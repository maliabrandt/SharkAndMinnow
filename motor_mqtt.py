...
#This code contains the receive_motor_info class. It takes 'left' and 'right' 
#as parameters, which determines whether it is controlling the left v right 
#motor. It connect to wifi, receives mqtt commands to turn on, off, go 
#forward, backwards, left, right, and buzz. Indicator lights on the pico turn 
#on once a message is received for each of the commands. 
#To run car, an instance of this class is created, and the main function is 
#called.
